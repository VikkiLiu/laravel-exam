                    ...
                    <div class="layui-panel">
                        <div class="layui-card ">
                            ...
                            <div class="layui-card-body " style="height: 195px">
                                最新试卷：<br>
                                <a href="{{url('teacher/sjgl')}}">{{$time1}}添加的新试题</a> <br>
                                <a href="{{url('teacher/sjgl')}}">>>更多</a><br>
                                <br>
                                最新试题：<br>
                                <a href="{{url('teacher/stgl')}}">{{$time2}}添加的新试题</a> <br>
                                <a href="{{url('teacher/stgl')}}">>>更多</a><br>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="layui-col-md11">
                    <div class="layui-panel">
                        <div class="layui-card ">
                            ...
                            <div class="layui-card-body " style="height: 200px">
                                <a href="{{url('teacher/ksgl')}}">{{$time3}}添加的新考试</a> <br>
                                <a href="{{url('teacher/ksgl')}}">>>更多</a><br>
                            </div>
                        </div>
                    </div>
                </div>
